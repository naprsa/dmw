...
$(".mobile-device .menu-has-sub").find(".fa:first").removeClass("fa-angle-right").addClass("fa-angle-down"), menu_Sub.click(function() {
    ...
    }) : ($(this).find(".fa:first").removeClass("fa-angle-down").addClass("fa-angle-up"), menu_Sub_Li.addClass("menu-opened"), menu_Sub_Li.find(".sub-dropdown:first").slideDown()), !1)
}), (menu_Sub_Li = menu_Sub.parent("li")).hover(function() {
